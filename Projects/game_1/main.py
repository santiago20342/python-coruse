...
# Snail
snail_fame_1 = pygame.image.load('graphics\\snail\\snail1.png').convert_alpha()
snail_fame_2 = pygame.image.load('graphics\\snail\\snail2.png').convert_alpha()
snail_frames = [snail_fame_1, snail_fame_2]
snail_frame_index = 0
